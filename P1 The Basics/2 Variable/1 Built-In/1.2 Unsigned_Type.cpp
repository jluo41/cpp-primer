...
int main()
{
	...
	std::cout << "u2 - u is: " << u2 - u << std::endl;
	std::cout << "u - u2 is: " << u - u2 << std::endl << std::endl;

	int i = 10, i2 = 42;
	std::cout << "int i = 10, i2 = 42; " << std::endl;
	std::cout << "i2 - i is: " << i2 - i << std::endl;
	std::cout << "i - i2 is: " << i - i2 << std::endl << std::endl;
...
*/
	...
	i = -42;
	if (i < u)
	  // false: i is converted to unsigned
		std::cout << i << std::endl;
	else
		// prints 10
		std::cout << u << std::endl;
